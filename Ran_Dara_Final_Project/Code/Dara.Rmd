...
```{r}
data%>%ggplot()+geom_point(aes(y=`Birth Rate`, x=`Percent of adults with less than a high school diploma, 2013-17`))

data%>%ggplot()+geom_point(aes(y=`Birth Rate`, x=`Percent of adults with a high school diploma only, 2013-17`))


data%>%ggplot()+geom_point(aes(y=`Birth Rate`, x=`Percent of adults completing some college or associate's degree, 2013-17`))


data%>%ggplot()+geom_point(aes(y=`Birth Rate`, x=`Percent of adults with a bachelor's degree or higher, 2013-17`))
